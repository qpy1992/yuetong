...
public class AreaTask extends AsyncTask<Void,String,String>{
    Context mContext;
    ...
    public AreaTask(Context mContext,List<HashMap<String,String>> list,List<String> strList,Tasks task,TextView tv){
...
//            lv.setPadding(60,20,40,10);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                task.setFBase12(list.get(i).get("itemid"));
